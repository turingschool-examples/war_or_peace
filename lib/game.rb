...
class Game
  ...
  def create_deck
    ...
    @full_deck = Deck.new([card1, card2, card3, card4, card5, card6, card7,
    ...
    card26, card27, card28, card29, card30, card31, card32, card33, card34,
  ...
  def split_deck
    ...
    # @shuffled_deck.each_slice(26) do |deck|
    #   deck1.add_card(deck)
    #   deck2.add_card(deck)
    # end
