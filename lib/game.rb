...
# Put those card into two Decks (some randomness would be nice here!) .shuffle 
end
...
# start the game print
# p Welcome to War! (or Peace) This game will be played with 52 cards.
# The players today are Megan and Aurora.
# Type 'GO' to start the game!
# ------------------------------------------------------------------

# user will be able to type GO, and a game will start
# p Turn 1: Megan won 2 cards
