class Game
  ...
  #   @card28 = Card.new(:diamond, 'King', 13)
  #   @card29 = Card.new(:diamond, 'Queen', 12)
  #   @card30 = Card.new(:diamond, 'Jack', 11)
  #   @card31 = Card.new(:diamond, '10', 10)
  #   @card32 = Card.new(:diamond, '9', 9)
  #   @card33 = Card.new(:diamond, '8', 8)
  #   @card34 = Card.new(:diamond, '7', 7)
  #   @card35 = Card.new(:diamond, '6', 6)
  #   @card36 = Card.new(:diamond, '5', 5)
  #   @card37 = Card.new(:diamond, '4', 4)
  #   @card38 = Card.new(:diamond, '3', 3)
  #   @card39 = Card.new(:diamond, '2', 2)
  #   @card40 = Card.new(:club, 'Ace', 14)
  #   @card41 = Card.new(:club, 'King', 13)
  #   @card42 = Card.new(:club, 'Queen', 12)
  #   @card43 = Card.new(:club, 'Jack', 11)
  #   @card44 = Card.new(:club, '10', 10)
  #   @card45 = Card.new(:club, '9', 9)
  #   @card46 = Card.new(:club, '8', 8)
  #   @card47 = Card.new(:club, '7', 7)
  #   @card48 = Card.new(:club, '6', 6)
  #   @card49 = Card.new(:club, '5', 5)
  #   @card50 = Card.new(:club, '4', 4)
  #   @card51 = Card.new(:club, '3', 3)
  ...
  #
  #   # @deck = Deck.new(@cards)
  #   @deck1_shuffled = @full_deck[0..25]
  #   @deck2_shuffled = @full_deck[26..52]
  #   @deck1 = Deck.new(@deck1_shuffled)
  #   @deck2 = Deck.new(@deck2_shuffled)
  #
  ...
  def start
    count = 0
    while @player1.deck.cards.empty? == false && @player2.deck.cards.empty? == false
      count += 1
      if @turn == :basic
        winner = @turn.winner
        @turn.pile_cards
        @turn.award_spoils(winner)
        puts "Turn #{count}: #{winner} won #{@spoils_of_war.length} cards"
      elsif @turn == :war
        winner = @turn.winner
        @turn.pile_cards
        @turn.award_spoils(winner)
        puts "Turn #{count}: WAR - #{winner} won #{@spoils_of_war.length} cards"
