class Game
  attr_reader :standard_deck, :count
  ...
  def start
    ...
    if start_command == "GO"
      ...
      p "That's not 'GO', lets try that again!"
      self.start
    end
  end
  ...
  @standard_deck = [card1, card2, card3, card4, card5, card6, card7, card8, card9,
