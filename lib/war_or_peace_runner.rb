...
dealer_deck = [card1, card2, card3, card4, card5, card6, card7, card8, card9, card10,
...
deck1 = Deck.new(dealer_deck.shuffle.slice(0, 25))
deck2 = Deck.new(dealer_deck.shuffle.slice(26, 51))
