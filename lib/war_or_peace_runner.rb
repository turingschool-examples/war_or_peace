...
deck = Deck.new(card1, card2, card3, card4, card5, card6, card7, card8, card9, card10, card11, card12, card13,
...
player1 = Player.new("Mario", deck1)
player2 = Player.new("Luigi", deck2)
