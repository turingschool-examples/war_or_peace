...
class WarOrPeaceRunnerTest < Minitest::Test
  ...
  def test_a_box_cards_has_52_cards
    @box_cards

    assert_equal 52, @box_cards.length
  end

  def test_deck_1_has_26_cards
    shuffled_deck = @box_cards.shuffle
    deck1 = shuffled_deck.take 26

    assert_equal 26, deck1.length
  end

  def test_deck2_has_26_cards
    shuffled_deck = @box_cards.shuffle
    deck1 = shuffled_deck.take 26
    deck2 = shuffled_deck.drop 26

    assert_equal 26, deck2.length
  end

  def test_deck1_does_not_have_deck2_cards
    shuffled_deck = @box_cards.shuffle
    deck1 = shuffled_deck.take 26
    deck2 = shuffled_deck.drop 26
