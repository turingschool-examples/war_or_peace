...
# turn type :basic
  ...
  def test_spoils_are_awarded_to_winner
    ...
    assert_equal turn.winner, player2
    assert_equal player1.deck.cards.count, 1
    assert_equal player2.deck.cards.count, 7
    assert_includes player2.deck.cards, card1
    assert_includes player2.deck.cards, card2
    assert_includes player2.deck.cards, card5
  end
