...
class TurnTest < Minitest::Test
  ...
  def test_turn_can_compaire_two_cards
    ...
    assert_equal false, turn.compare(0)
  end
  ...
  def test_turns_have_a_type_with_less_then_3_cards
    card1 = Card.new(:heart, 'Jack', 11)
    card2 = Card.new(:heart, '10', 10)
    card3 = Card.new(:heart, '9', 9)
    card4 = Card.new(:diamond, 'Jack', 11)
  ...
  def test_there_is_a_wenner_with_less_then_3_cards
    card1 = Card.new(:heart, 'Jack', 11)
    card2 = Card.new(:heart, '10', 10)
    card3 = Card.new(:heart, '9', 9)
    card4 = Card.new(:diamond, 'Jack', 11)
