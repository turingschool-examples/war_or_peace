...
class TurnTest < Minitest::Test
  ...
  def test_winner_from_rank
    ...
    assert_equal player2, turn.winner_from_rank(0)
    assert_equal player1, turn.winner_from_rank(1)
    assert_equal player2, turn.winner_from_rank(2)
  end
