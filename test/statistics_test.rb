...
game_2 = Game.new(player_1, player_2)
game_3 = Game.new(player_1, player_2)
game_4 = Game.new(player_1, player_2)
game_5 = Game.new(player_1, player_2)
game_6 = Game.new(player_1, player_2)
game_7 = Game.new(player_1, player_2)
game_8 = Game.new(player_1, player_2)
game_9 = Game.new(player_1, player_2)
game_10 = Game.new(player_1, player_2)
games = [game_1, game_2, game_3, game_4, game_5, game_6, game_7, game_8, game_9, game_10]
game_1.start
game_2.start
game_3.start
game_4.start
