...
describe Turn do
        ...
        describe  'pile_cards' do 
            ...
            it ':mutually_assured_destruction, remove top three cards in deck, 
                not sent to spoils pile (just removed)' do
                card1 = Card.new(:heart, 'Jack', 11)
                card2 = Card.new(:heart, '10', 10)
                card3 = Card.new(:heart, '9', 9)
                card4 = Card.new(:diamond, 'Jack', 11)
        ...
        describe 'award_spoils' do 
            it ':basic add each of the cards in the spoils_of_war array 
            ...
            it ':war add each of the cards in the spoils_of_war array 
            to the deck that belongs to the winner of the turn' do
