...
describe Turn do
  ...
  describe '#winner' do
    ...
    it 'return no winner for mutually assured destruction' do
      ...
      card4 = Card.new(:diamond, 'Jack', 11)
      card5 = Card.new(:heart, '8', 8)
      card6 = Card.new(:diamond, '8', 8) #Refactor, card six is 1st difference
      card7 = Card.new(:heart, '3', 3)
      card8 = Card.new(:diamond, '2', 2)
      deck1 = Deck.new([card1, card2, card5, card8])
      deck2 = Deck.new([card4, card3, card6, card7]) #Refactor, 4/3 swapped
  ...
  describe '#pile_cards' do
    ...
    it 'put both sets of index 0-2 cards into spoils for war' do
      ...
      deck1 = Deck.new([card1, card2, card5, card8])
      deck2 = Deck.new([card4, card3, card6, card7]) #refactor, card 3/4 swapped
