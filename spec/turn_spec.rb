...
RSpec.describe Turn do 
  ...
  describe '#type' do 
    ...
    it 'is a MUTUALLY ASSURED DESTRUCTION type when both players ranks at 0 and 2 are the same' do 
      card1 = Card.new(:heart, 'Jack', 11)    
      card2 = Card.new(:heart, '10', 10)    
      card3 = Card.new(:heart, '9', 9)    
      card4 = Card.new(:diamond, 'Jack', 11)    
  ...
  describe '#winner' do 
    ...
    it 'returns no winner for a MUTUALLY ASSURED DESTRUCTION type of round' do 
      card1 = Card.new(:heart, 'Jack', 11)    
      card2 = Card.new(:heart, '10', 10)    
      card3 = Card.new(:heart, '9', 9)    
      card4 = Card.new(:diamond, 'Jack', 11)    
  ...
  describe '#pile_cards' do 
    ...
    it 'removes each players cards from their decks' do 
      card1 = Card.new(:heart, 'Jack', 11)    
      card2 = Card.new(:heart, '10', 10)    
      card3 = Card.new(:heart, '9', 9)    
      card4 = Card.new(:diamond, 'Jack', 11)    
