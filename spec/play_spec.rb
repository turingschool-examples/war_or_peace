...
describe Play do
  ...
  describe "#start" do
    it "creates new instances of Turn until a player has 0 cards" do
      card_1 = Card.new(:diamonds, 'ace', 14)
      card_2 = Card.new(:diamonds, 'king', 13)
      card_3 = Card.new(:diamonds, 'queen', 12)
      card_4 = Card.new(:diamonds, 'jack', 11)
      ...
      game.start
      num_cards = []
      num_cards.push(player1.deck.cards.length, player2.deck.cards.length)

      expect(num_cards).to include(0)
    end
  end
