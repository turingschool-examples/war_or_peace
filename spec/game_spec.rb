...
RSpec.describe Game do
  ...
  it 'prints correct first turn info' do
    standard_deck = [
    ...
    cards1 = standard_deck[0..26]
    cards2 = standard_deck[27..-1]
    ...
    expect{new_game.start_game(2)}.to output("Turn 2: Aurora won 2 cards\n").to_stdout
  end

  it 'counts turn num' do
    standard_deck = [
      card1 = Card.new(:diamond, '2', 2),
      card2 = Card.new(:diamond, '3', 3),
      card3 = Card.new(:diamond, '4', 4),
    ...
    expect{new_game.play_game}.to output("1000000").to_stdout
  end
