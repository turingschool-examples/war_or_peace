...
card02 = Card.new(:spade, '2', 2)
card03 = Card.new(:spade, '3', 3)
card04 = Card.new(:spade, '4', 4)
card05 = Card.new(:spade, '5', 5)
card06 = Card.new(:spade, '6', 6)
card07 = Card.new(:spade, '7', 7)
card08 = Card.new(:spade, '8', 8)
card09 = Card.new(:spade, '9', 9)
card10 = Card.new(:spade, '10', 10)
card11 = Card.new(:spade, 'Jack', 11)
card12 = Card.new(:spade, 'Queen', 12)
card13 = Card.new(:spade, 'King', 13)
card01 = Card.new(:spade, 'Ace', 14)
