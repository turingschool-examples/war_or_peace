...
#create deck of cards(need an array to hold the deck)
game_deck = [card1, card2, card3, card4, card5, card6, card7, card8, card9, card10,
card11, card12, card13, card14, card15, card16, card17, card18, card19, card20, card21,
card22, card23, card24, card25, card26, card27, card28, card29, card30, card31, card32,
card33, card34, card35, card36, card37, card38, card39, card40, card41, card42, card43,
...
player1 = Player.new("Mehlub", deck1)
player2 = Player.new("Andrew", deck2
#start the game
